...
bind("n", "<leader>gs", gs.stage_hunk)
bind("n", "<leader>gr", gs.reset_hunk)
bind("v", "<leader>gs", function()
	gs.stage_hunk({ vim.fn.line("."), vim.fn.line("v") })
end)
bind("v", "<leader>hr", function()
	gs.reset_hunk({ vim.fn.line("."), vim.fn.line("v") })
end)
bind("n", "<leader>gS", gs.stage_buffer)
bind("n", "<leader>gu", gs.undo_stage_hunk)
bind("n", "<leader>gR", gs.reset_buffer)
bind("n", "<leader>gp", gs.preview_hunk)
bind("n", "<leader>gb", function()
	gs.blame_line({ full = true })
end)
bind("n", "<leader>gtb", gs.toggle_current_line_blame)
bind("n", "<leader>gd", gs.diffthis)
